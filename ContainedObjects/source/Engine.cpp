...
namespace COBJ
{
	...
	void Engine::parseFile(const std::wstring& filePath)
	{
		...
		psr = ContainedObjectsParserNew(tstream.get());  // CParserNew is generated by ANTLR3
	...
	Result Engine::getClass(const std::wstring& className, boost::shared_ptr<IClass>& pClass)
	{
		return ErrorCode::NotImplemented;
	}

	Result Engine::getInterface(const std::wstring& interfaceName, boost::shared_ptr<IInterface>& pInterface)
	{
		return ErrorCode::NotImplemented;
	}
